  ...
  return (
    <div className="bg-gray-50 px-4 py-10 lg:py-14">
      <div className="mx-auto max-w-content">
        <div className="flex flex-col gap-8 lg:grid lg:grid-cols-[minmax(260px,360px)_minmax(300px,1fr)] lg:items-start lg:gap-10 xl:gap-12">
          <div className="lg:sticky lg:top-8 lg:z-10 lg:max-h-[calc(100vh-4rem)] lg:overflow-y-auto lg:self-start">
          ...
          <section className="flex min-h-0 min-w-0 flex-col rounded-2xl border border-gray-200 bg-white px-5 py-8 shadow-sm sm:px-6 lg:py-10">
            <div className="mb-0 flex shrink-0 flex-col gap-6 sm:flex-row sm:items-start sm:justify-between sm:gap-8">
              <header className="min-w-0 flex-1 space-y-3 sm:max-w-xl">
